...
export function SmartCoinsCard({ balance }: { balance: number }) {
  return (
    <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1a0d3b] via-[#2d1465] to-[#1a0d3b] p-5 text-white shadow-xl shadow-teal-900/30">
      {/* Decorative glow */}
      <div className="absolute -right-6 -top-6 h-32 w-32 rounded-full bg-orange-500/30 blur-3xl" />
      ...
      <div className="relative">
        ...
        <div className="mt-3 flex items-end justify-between gap-4">
          ...
          <Gift className="h-12 w-12 text-orange-300/80" />
        </div>

        <Link
          href="/wallet"
          className="mt-4 inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-orange-500 to-teal-600 px-4 py-2 text-sm font-medium shadow-lg shadow-teal-500/30 transition-transform hover:scale-[1.02]"
        >
